    ...
    render() {
                ...
                <ul className="app-nav">
                    ...
                    <li className="dropdown"><a className="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i className="fa fa-user fa-lg"></i></a>
                        <ul className="dropdown-menu settings-menu dropdown-menu-right">
                            ...
                            <li><a className="dropdown-item" href="#" onClick={this.logout.bind(this)}><i className="fa fa-sign-out fa-lg"></i> Logout</a></li>
                        </ul>
                    </li>
                </ul>
        );
        const notAuth = (
            ...
            <ul className="app-nav">
                ...
                <li><Link className="app-nav__item" to="/signup" ><i className="fa fa-bell-o fa-lg"></i>Sing Up</Link></li>
                <li><Link className="app-nav__item" to="/login" ><i className="fa fa-sign-in"></i>Login</Link></li>
            </ul>
        );
        return (
            ...
            <header className="app-header">
                {isAuthenticated && <a className="app-header__logo" href="index.html">Vali</a>}
                {isAuthenticated && <a className="app-sidebar__toggle" href="#" data-toggle="sidebar" aria-label="Hide Sidebar"></a>}
                {isAuthenticated ? navAuth : notAuth}
            </header>
